  ...
  return (
    <section className="privacy">
      <div className="container">
        ...
        <p>Personal information is collected through the following methods:</p>
        <ul>
        ...
        <p>We do not sell or rent collected personal information to third parties. However, personal information may be shared for advertising purposes with Google AdMob, which is necessary for ad serving and targeting.</p>

        <h2>6. In-App Purchases</h2>
        <p>The Game offers in-app purchases to enhance the user experience. When you make in-app purchases, additional information such as payment information may be collected to process these transactions. This information is handled securely and is not shared with third parties except as necessary to process the transaction.</p>
      </div>
    </section>
  );
}
